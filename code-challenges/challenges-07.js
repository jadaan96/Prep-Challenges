...
const objLat = (objecat) => {
    ...
    return `my name is ${objecat.firstName.charAt(0).toUpperCase() +
        objecat.firstName.slice(1)} ${objecat.lastName.charAt(0).toUpperCase() +
        objecat.lastName.slice(1)} I am ${objecat.age} YO, and I love ${objecat.hobby}.`
}
...
const cvFormatter = (arr) => {
   ...
   for (let i = 0 ; i < arr.length ; i ++){
    ...
    if(arr[i].yearsOfExperience > 1){
        ...
        received.push({fullName: fullName,
        tech: arr[i].tech})
    }
